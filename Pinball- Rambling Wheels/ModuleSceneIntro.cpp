...
bool ModuleSceneIntro::Start()
{
	...
	461,703, 461,635, 456,630, 449,630,	444,635, 373,762, 373,767,
	375,773, 380,775, 385,775, 455,720, 458,715, 460,711 };

	App->physics->CreateChain(0, 0, red_triangle_right, 26);

	// Pivot 0, 0
	int red_trieangle_left[28] = {
	98,629,	105,630, 110,636, 126,662, 155,719, 179,764,
	180,770, 175,775, 168,775, 98,719, 94,713, 93,705, 93, 634 };
...
update_status ModuleSceneIntro::Update()
{
	...
	if (App->input->GetKey(SDL_SCANCODE_SPACE) == KEY_UP && App->player->lives == 0)
	{
		LOG("RESTARTING");
		App->player->dead = false;
		App->player->lives = 3;
		App->player->SetBallPosition(Ball_x, Ball_y);
		App->player->score_points = 0;
	}
